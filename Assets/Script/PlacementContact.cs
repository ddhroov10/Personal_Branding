...
public class PlacementContact : MonoBehaviour
{
    //[SerializeField]
    //private GameObject welcomePanel;

    [SerializeField]
    private PlacementObject_Contact placedObject;
    ...
    void Update()
    {
        ...
        if (Input.touchCount > 0)
        {
            ...
            if (touch.phase == TouchPhase.Began)
            {
                ...
                {
                    PlacementObject_Contact placementObject = hitObject.transform.GetComponent<PlacementObject_Contact>();
                ...
                {
                    PlacementObject_Contact placementObject = placedObject.GetComponent<PlacementObject_Contact>();
                    MeshRenderer placementObjectMeshRenderer = placedObject.GetComponent<MeshRenderer>();
                    if (placementObject != null)
                    {
