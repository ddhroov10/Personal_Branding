...
public class PlacementObject_Project : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    private Canvas canvasComponent2;

    [SerializeField]
    private Canvas canvasComponent3;

    [SerializeField]
    private Canvas canvasComponent4;
    ...
    public void ToggleCanvas()
    {
        ...
        canvasComponent2?.gameObject.SetActive(IsSelected);
        canvasComponent3?.gameObject.SetActive(IsSelected);
        canvasComponent4?.gameObject.SetActive(IsSelected);
    }
}